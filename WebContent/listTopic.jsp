...
<script type="text/javascript">
	...
	function showData(data){
		...
		for(var i=0;i<data.length;i++){
			var obj = data[i];
			var detail = "<a href='do?m=detailTopic&tid="+obj.tid+"'>查看详细</a>";
...
<body style="background:url(images/topicbk.jpg) no-repeat; width:1024px;height:640px;">
	...
	<br/>
	<div >
	根据话题搜索:<input id="ht" onkeyup="queryCandA();"/> 
	根据作者搜索:<input id="zz" onkeyup="queryCandA();"/> 
	</div>
	<br/>
	<h1>发布话题</h1>
	 <textarea id="ctt" rows="11" cols="11"></textarea>
	 <br/><input type="button" value=" 发布 " onclick="publish();"/>
